            ...
            <div class="col-md-4 mb-2 mb-sm-0 text-center">
                <div class="card user__card text-bg-dark">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-info client__btn m-1">Cambiar contraseña <i class="bi bi-pencil"></i></button>
                    </div>
                </div>
            </div>
        </div>
