    ...
    <div class="col-md-4 mb-2 mb-sm-0 text-center">
        <div class="card user__card text-bg-dark">
            <div class="card-body">
                ...
                <button type="button" id="btn-admin-eliminar" class="btn btn-outline-danger m-1">Eliminar cuenta <i class="bi bi-pencil"></i></button>
            </div>
        </div>
    </div>
    <div class="col-md-4 mb-2 mb-sm-0 text-center">
    ...
    <div class="col-md-4 mb-2 mb-sm-0 text-center">
        <div class="card user__card text-bg-dark">
            <div class="card-body">
                ...
                <button type="button" id="btn-admin-pass" class="btn btn-outline-info admin__btn m-1">Cambiar contraseña <i class="bi bi-pencil"></i></button>
            </div>
        </div>
    </div>
    </div>
